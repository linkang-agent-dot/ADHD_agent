...
print("=" * 60)
print("提交活动: {} ({})".format(test_payload["name"], test_payload["activityConfigId"]))
...
# 调用 iGame 接口
print("\n调用 activity/add_activity/submitActivity 接口...")
cmd = ["node", IGAME_SCRIPT, "write", "activity/add_activity/submitActivity", params_json]

...
|-------|--------------|-------|
| gemini-3.1-pro-preview | ~1 hour | Best quality |
| gemini-3.1-flash | ~1 hour | Faster, cheaper |
...
|-------|-------|---------|------|----------|
| gemini-3.1-pro-preview | Slow | Best | High | Deep analysis |
| gemini-3.1-flash | Fast | Good | Low | Quick summaries |

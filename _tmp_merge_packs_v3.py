...
lines = []
lines.append("=" * 70)
lines.append("v3 合并后（皮肤GACHA按节日合并）")
lines.append("=" * 70)
...
result = '\n'.join(lines)
with open(r'C:\ADHD_agent\_tmp_merge_preview_v3.txt', 'w', encoding='utf-8') as f:
    f.write(result)

# 同时保存 merge rules 供后续 HTML 生成使用
with open(r'C:\ADHD_agent\_tmp_merge_rules_v3.json', 'w', encoding='utf-8') as f:

...
GREEN=rgb("8EE085");HDR=rgb("D9E6F2")
...
for col,w in [(0,120),(1,140),(2,360),(3,250),(4,120)]:
...
for i,r in enumerate(rows):
    ...
    elif a.startswith("①") or a.startswith("②") or a.startswith("③") or a.startswith("④") or a.startswith("⑤") or a.startswith("⑥") or a.startswith("⑦") or a.startswith("⑧") or a.startswith("⑨"):

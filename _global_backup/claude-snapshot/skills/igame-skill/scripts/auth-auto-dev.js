// iGame 一键认证：启动 Chrome(专属profile) -> CDP 注入提取 token/clientId -> 写 ~/.igame-auth-dev.json
...
const REGION_ID = '201';
const PORT = 9222;
const URL = 'https://igame-dev.tap4fun.com';
const PROFILE = path.join(os.homedir(), '.igame-chrome-profile');
const AUTH_FILE = path.join(os.homedir(), '.igame-auth-dev.json');

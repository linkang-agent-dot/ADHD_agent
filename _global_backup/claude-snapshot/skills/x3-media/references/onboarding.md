...
| grfal-api skill (vendored) | 确认项目 skill 根目录下有 `vendor/grfal-api/scripts/call_grfal.py` | 必须（主后端，**唯一入口**） |
  ...
  questions:
    - id: "media_type"
      ...
      options:
        ...
        - id: "march_emoji"   label: "行军表情 — 游戏内贴纸式单帧表情，透明底 256×256"
        - id: "dynamic_march_emoji"   label: "动态行军表情 — 固定 4×4 半身循环逐帧表，每格 256×256，透明底 1024×1024"
        - id: "achievement"   label: "成就徽章 — 成就图标，1中央+5底板，128×128"
        - id: "game_video"    label: "游戏视频 — 视频生成+处理+Unity集成+C#代码"
        - id: "activity_icon" label: "活动图标 — 活动入口/奖励图标，透明底 256×256"

...
## ⚠️GIF 交付已改道（2026-07-27 用户裁决）：GIF 一律=先出视频→切帧→合成（见 video-model-routing.md §3.5），本节 sheet_to_gif 对 GIF 交付废弃；sprite sheet 仅在用户明确要逐帧表本体时交付。

### （留档）原 GIF 章节（2026-07-08 柴犬案）

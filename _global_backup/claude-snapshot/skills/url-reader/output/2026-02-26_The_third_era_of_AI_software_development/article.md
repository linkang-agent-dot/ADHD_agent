...
1. They spend their time breaking down problems, reviewing artifacts / code, and giving feedback.
1. They spin up multiple agents simultaneously instead of handholding one to completion.

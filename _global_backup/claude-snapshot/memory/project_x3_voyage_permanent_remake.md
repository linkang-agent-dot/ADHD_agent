...
metadata: 
  ...
  modified: 2026-07-30T10:31:21.612Z
---

# X3 航海之路常驻版换血（2026-07-14 配置全落）

## ⏸️ 版本回归（07-30 初版·用户裁决量太少，**正式回归延后至下周≈8/3-8/9 重跑**）
重跑姿势：口径全套已定死在 `KB\产出-数据分析\X3_双手册+航海常驻回归\数据口径统一.md`（全家族=链条207x+阶梯+珍宝罐；统一生命周期=每服开服+12天起6天窗；逐服中位；对照=老版新服42服）——**照口径重拉数刷新报告即可，别重推口径**。届时四个观察项一并收：①全家族中位是否稳≥老版$65 ②链条缩水($25vs$65)是分流还是首批噪声 ③阶梯1→2留存回不回70%+ ④纪念卡1000节点到达分布；另复购化(7/29版本)若已覆盖进窗服,珍宝罐复购率一起看。
报告=`KB\产出-数据分析\X3_双手册+航海常驻回归\版本回归_航海之路常驻_20260730.html`（**独立HTML**,用户定与双手册分开）。**机制全通**：老102801末单7/17后零残留(无双开)、新102804按TC2702自动进窗、阶段奖励链路活着(罗盘在发)。**付费占比(07-30二次修正,按服对齐后翻案)**：逐服中位新$74/3.1% **反超**老成熟服轮中位$17/2.07%(聚合3.35%vs4.61%"低七成"是鲸鱼服1910/1920+服龄结构的均值假象,作废)；★结构发现=老102801自5/20只覆盖≤2010成熟服、2020-2430新服段零航海——**常驻化=航海首进新服D13拓荒期,纯新增覆盖**(开服→首航单恒12-13天,D13实证)。口径定死=按服首轮5天窗+中位数。**★07-30终版结论(用户三轮点破后定稿)——变现件1→3,中位$65→$111(+71%)**：①老102801在2020-2430共42新服准点D13开5天窗跑了俩月(参与口径核实),**唯一变现件=链条包207101-113「航海之路活动-礼包」**(PackType=11免费/付费交替,窗口绑定;42/42服有售,中位$65/服·均值$124,2130有$935鲸鱼服);老版缺的是成就礼包(老组104 TimeCycle空→新服实例不创建,2801xxx只在成熟服海域轮卖过)和珍宝罐(无此件),组105填TC=2702正是7/14改造补的洞;②新102804全家族(链条+阶梯+珍宝罐)6完整窗服**中位$111/服(链~25/阶梯52/罐30)·占比中位4.04% vs 老1.34%(~3×)**——统一生命周期一把尺(48服全取开服+12天起6天窗),服体量偏差已消(新批窗盘中位反而更小$2778vs$3676),新组占比2.2-5.6%紧分布、中位站老组~80分位=整组抬升;⚠️分流信号=新版链条中位$25 vs 老$65,阶梯+珍宝罐部分吃链条的钱非全净增,8月中批次复核;③邻服A/B(2420/2430老 vs 2440/2450新):参与同级(854/524 vs 817/551)、付费$95/$310 vs $272/$236、服级盘比同轨0.33-0.38(净拉动待批次)。**作废结论链:纯新增覆盖→变现0→1→(终版)变现件1→3**。⚠️教训两条(已进must-check/口径统一):判活动覆盖用参与口径禁订单口径;圈活动收入先从Pack表按活动名圈全全部付费件家族+开放式全量iap扫描互验,禁只按AchievePack一张表推(本案链条包就是这么漏的)。活动配置ID在ods_user_activity.attribute1的activityCfgID。观察项挂账(第2-3批海域轮,~8月中)：①阶梯1→2档留存49% vs 老86%(首档参与反更高5.3/服vs3.3)②纪念卡新5节点零发放=没人到1000珍珠贝(非BUG,链路已排除)。⚠️**珍宝罐"复购=0"是误判已纠(用户07-30点破)**：复购化随7/29马戏版本走,观察窗内280003还是单次买断——复购效果等复购化覆盖进窗服后另测。180041实际出口=兑换商店1332(19人27张)。

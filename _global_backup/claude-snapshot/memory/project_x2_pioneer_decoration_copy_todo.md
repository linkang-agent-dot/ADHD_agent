...
2. **主接线(3D模型)**：✅**已完成+导表(2026-06-05)**。地板9变体其实全做了(d~i误名Summer已改Pioneer)、墙纸11件覆盖14节点、壁灯1覆盖2、柜台3件；**仅墙面3(Pendant03)确认不做**。已录27 prefab DK(1511094092-118)+6 J组合Icon、填满1105(slot照抄占星/主题换拓荒)、导表Furniture+FurnitureBuild(f1253bf66排除墙面3)、push client(5b948d731caa)。本体+图标游戏内可见。机制见[[reference-x2-indoor-furniture-assets]]。
3. **文案(原任务)**：✅**已完成+导表(2026-06-05, commit e38b2d862)**。6件按实物+包装重起名+重写描述+18语言，i18n EVENT行7462-7475，已导表生效。新名：350寰宇星盘/351拓土方阶/352垦荒木墙/353荒野花信/354夜归铜灯/356边境货栈。调性参考占星(星象仪摆件)+P2(流水花庭)。

## ✅ 全任务完成(2026-06-05)
6件拓荒装饰 道具+本体3D+放置入口+图标+文案 三侧全通，已导表+push(x2gdconf:214457fe1/f1253bf66/e38b2d862, x2client:5b948d731caa等)。墙面3(355)确认弃用。遗留小尾巴:FurnitureBuild的355行还在GSheet(已排除导表不进游戏),要彻底删GSheet回头再说。

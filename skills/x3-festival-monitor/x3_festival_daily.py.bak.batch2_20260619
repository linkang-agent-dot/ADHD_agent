...
# ============ 配置 ============
DATASOURCE = "TRINO_HF"
FESTIVAL_NAME = "夏日节1880-1900服"
# 第二批次（1880/1890/1900 服）夏日恋语开场日 = 2026-06-09：
#   夏日专属装饰包 210917/918/919 在该批服 06-05~06-08 收入为 0、06-09 首次出单 → D0=06-09 实测成立。
#   （第一批 1-88 服 05-29→06-08 已收尾，历史日报 HTML 已逐日落盘归档，此处改指第二批。）
FESTIVAL_D0 = "2026-06-09"
...
FESTIVAL_END_TS = "2026-06-19 08:00:00"  # 第二批沿用 10 天窗口（06-09 08:00 → 06-19 08:00 北京）
FEST_TIME_GUARD = f"o.created_at < TIMESTAMP '{FESTIVAL_END_TS}'"
BASELINE_START = "2026-05-26"       # 基线 14 日（D0 前；该批服此窗口无夏日流水，已实测干净）
BASELINE_END = "2026-06-08"
# 双服段（核心：同期对比要"服务器生命周期一致" = 各期取「D0 时距开服天数(服龄)处于同一阶段」的服，
#   排除新服爆发期对对比的干扰。**按服龄阈值匹配，不是同一批物理服**）：
# - 夏日(本期，主报告+对比夏日侧) = 第二批 1880/1890/1900 三服：D0(06-09) 时服龄 43/39/35 天
#   （1880 开服 04-27 / 1890 05-01 / 1900 05-05），刚过 D35 的年轻服。
# - 情人节(对比上期侧) = 1530/1540/1550 三服：情人节 D0(02-06) 时服龄 43/39/35 天
#   （1530 开服 12-25 / 1540 12-29 / 1550 01-02），与本批服龄逐一精确对齐 → 生命周期一致。
# 两期各取"D0 时服龄 35-43 天"的同档服，物理服不同 → 排除生命周期影响。
SERVER_FILTER = "AND TRY_CAST(o.server_id AS INTEGER) BETWEEN 1880 AND 1900"      # 第二批夏日 = 1880/1890/1900 三服
# ✅ 对比侧已按本批服龄重校准(2026-06-18)：情人节 1530-1550 服 D0 服龄 43/39/35 天，对齐本批 43/39/35。
...
SERVER_LABEL = "本期夏日第二批 1880/1890/1900(D0服龄43/39/35d)；对比侧情人节 1530/1540/1550(D0服龄43/39/35d) 生命周期逐一对齐"

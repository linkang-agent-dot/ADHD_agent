...
# 马戏节 61 包白名单（2026-07-31 origin/dev ActvOnline 100599 快照，与 100600 寻宝累充相同；
#   含跨节日复用包 许愿池 1002001 + 周卡 2026101-104，靠时间窗与深海分账）
_CIRCUS_IDS = ("'13025','13026','13027','13028','13029','13030','13031','13032','13033',"
               ...
               "'280002','280004','280005','800010','800011','800012','800013','800014',"
               "'820011','820012','1002001','2026101','2026102','2026103','2026104',"
               "'2801012','2801013','2801014','2801015','2801016','2801017',"
               "'2801018','2801019','2801020','2801021','2801022'")

# 马戏 87 服 D35+ 显式清单（2026-07-31 部署定案，取自 circus_batch_0731.json；别用 BETWEEN）
...
FESTIVALS = [
    {"name": "马戏节", "color": "#f472b6", "d0": "2026-07-31",
     "pred": (f"(o.iap_id IN ({_CIRCUS_IDS}) "
              "AND o.created_at >= TIMESTAMP '2026-07-31 08:00:00' "
              "AND o.created_at <  TIMESTAMP '2026-08-14 08:00:00')")},
...
SEGMENTS = [
    ...
    {"key": "circus", "label": "马戏节范围 87服", "note": "server_id 1170-2290 非连续显式清单（D35+ 老服，2026-07-31 部署段）",
     "filter": f"AND TRY_CAST(o.server_id AS INTEGER) IN ({_CIRCUS_SERVERS})"},

...
CIRCUS = {"101026": ("1209", "144"), "101027": ("1211|1212", "144"),
          "100599": ("1209|1057", "144"), "100600": ("1207|1057", "144"),
          ...
          "105014": ("1209|1210", "144"), "102250": ("1209|1210", "144"),
          "108201": ("", "144"), "109101": ("", "144"), "101407": ("1210", "144"),
          "103101": ("1207|1208", "144"), "103102": ("", "144"),
          "101830": ("1210", "144"), "101831": ("1210", "144")}
...
TAGS = ("_1209", "_1210", "_1213", "_82006", "_16043", "_16044", "_16045",
...
# 共享源资产不能按使用方节日改文案：Item180081/MemorialCard81 是深海“海妖低语”，
# “深海/海妖航线”与道具本体一致。若马戏不应复用，应改奖励引用而不是改这个 key。

# 6. 玩家可见 Pack 文本硬缺口（CPackCfg.Name/Desc 按固定 key 读取，缺 key 会返回空）
for k in ["TXT_Pack_Name_81310", "TXT_Pack_Name_81312", "TXT_Pack_Name_81313",
          "TXT_Pack_Name_81314", "TXT_Pack_Name_81315", "TXT_Pack_Desc_211046"]:
    if k not in keys:
        issues.append("Pack玩家文本缺key:" + k)

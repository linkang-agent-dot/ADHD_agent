# -*- coding: utf-8 -*-
"""把 v2 静态图拷进交付目录 + 出 _全屏对照_v2.png 缩略拼版（v1 图不动）"""
...
d.text((pad, 16), 'X3 挖孔（异星探索）· 老模块界面 v2「对齐 X3 现成 prefab」· 1080×1920 · 2026-08-04',
...
for i, (n, im) in enumerate(ims):
    ...
    d.text((x, y + TH + 8), n.replace('_v2对齐X3', ''), fill=(232, 220, 196), font=f)
tmp = os.path.join(OUT, '_全屏对照_v2.png.tmp')
sheet.save(tmp, format='PNG')
os.replace(tmp, os.path.join(OUT, '_全屏对照_v2.png'))

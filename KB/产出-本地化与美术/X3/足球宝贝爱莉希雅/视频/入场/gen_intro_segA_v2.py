...
PROMPT = (
 ...
 "First second: she springs into the scene from the right edge with two light bouncy cheer steps, arriving at the center, gold pom-poms swinging with her stride, with a subtle, composed half-smile toward the camera — restrained and confident, lips closed, NOT a beaming grin. "
 ...
 "Final stretch: the dance settles down smoothly — her gaze drops to the soccer ball on the ground, her expression turns quietly focused with just a hint of a knowing smile, "
 ...
 "Her expression stays understated throughout: a faint, cool, confident smile at most, lips closed, never opening, never a wide grin. Smooth, coherent, natural motion; no warping, no flicker, no camera movement. "
...
params = {'prompt': PROMPT, 'model': 'seadance', 'ref_types': '首帧图像', 'duration': 5, 'aspect_ratio': '9:16'}
...
for i, u in enumerate(flat(res), 1):
    ...
    dst = os.path.join(OUT, f'intro_segA_v2_{i}{ext}')

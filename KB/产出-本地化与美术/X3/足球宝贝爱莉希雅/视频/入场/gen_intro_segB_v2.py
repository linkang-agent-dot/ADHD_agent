...
PROMPT = (
 "A skillful, natural soccer juggling animation of the same cheerleader character, identical face, outfit and art style across all frames. Locked camera, plain white background, she stays around the center spot, holding a gold pom-pom in each hand the whole time. One continuous natural motion line: She starts with her right foot resting on top of the soccer ball, wearing a faint, composed half-smile. She rolls the ball back slightly with her sole and flicks it UP with her instep — the ball rises in a clear, slow arc to knee height. She bounces it once on her right knee, then once more gently on her instep, her whole body bouncing elastically with each touch, eyes following the ball with quiet focus. On the last bounce the ball pops up to chest height and she catches it smoothly between her LEFT forearm and her side, tucking it snugly under her left arm, pom-pom still in her left hand. Then she settles: weight sinks calmly into both feet, posture straightens to face the camera, and she eases EXACTLY into the final reference pose — same stance, same arm positions, ball tucked under her left arm. During the settle her expression GRADUALLY and smoothly transitions: the faint smile fades over a full second into the calm, cool, composed gaze of the final reference frame — chin level, eyes steady on the camera, self-assured and aloof — the change is continuous and natural, never a sudden switch. The ball moves in slow, clear, physically believable arcs and never disappears or duplicates. Lips stay closed throughout; facial changes are slow and continuous. Smooth, coherent, natural; no warping, no flicker, no camera movement. Preserve her exact face, outfit, colors and painterly style."
)
...
for i, u in enumerate(flat(res), 1):
    ...
    dst = os.path.join(OUT, f'intro_segB_v2_{i}{ext}')

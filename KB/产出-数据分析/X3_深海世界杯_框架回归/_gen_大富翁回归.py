...
<tr><td class="l"><b>4. 存钱罐（储蓄罐）复购优化</b><br><span class="dim">新增 $49.99 / $99.99 档 + UTC0 日刷新复购化</span></td>
<td class="l">在现有 $19.99 单档之上新增 $49.99 / $99.99 两档；购买后 UTC 0:00 刷新该档购买次数、可再次购买，<b>各档位独立计次</b>——买 $19.99 只刷新 $19.99 档的购买次数，$49.99 档的当前储蓄次数不变</td>
<td class="l">02/03 章：存钱罐现为单档单笔买断（157 人 × 1 单、收钱前置），模块缺"随进度持续吐钱"的复购件；03 章重叠表：88% 买家是模块内老面孔=深度客群现成，高档位有承接对象</td>
<td class="l">档位上探（$19.99→$99.99）与复购化双开：把 $3.1k 的一次性顺手件改成模块内第二个复购位，且不动送达层入口设计</td></tr>
</table>

...
def main() -> None:
    ...
    def row(label: str, sub: str, css: str, cells: list[tuple[str, str, list[tuple[str, str]]]]) -> str:
        price = {"texture": "$300", "dynamic": "$600 / $2,000"}.get(css, "")

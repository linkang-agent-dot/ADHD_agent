...
</style></head><body><main class="page"><header class="hero"><small>X3 · 节日外显模块养成线</small><h1>航迹皮肤内容排期｜9–12月</h1><p>月度内容＋上榜门槛＋投放活动</p></header><div class="thesis">一句话：每月1款节日航迹皮肤，玩家累计$300获得挖矿排行榜上榜资格，并通过排名竞争获取。</div><div class="summary"><div><b>4款</b><span>9–12月每月1款节日航迹</span></div><div><b>$300</b><span>统一上榜资格门槛</span></div><div><b>挖矿排行榜</b><span>唯一投放方式</span></div></div><div class="section-title"><h2>9–12月航迹内容甘特图</h2><span>四款实机效果与挖矿Demo均在甘特内部</span></div><section class="gantt"><div class="corner">内容类型 / 月份</div>{heads}<div class="lane"><b>航迹皮肤</b><strong>$300上榜</strong><span>排行榜竞争奖励</span></div>{cells}<div class="lane activity-lane"><b>投放活动</b><strong>挖矿排行榜</strong><span>小游戏Demo</span></div><article class="activity-cell"><img src="{mining_src}" alt="挖矿小游戏排行榜Demo"><div><h3>挖矿小游戏排行榜</h3><p>玩家通过坚屏挖矿关卡推进与排行榜竞争获取当月航迹皮肤。</p><p>累计$300只负责解锁上榜资格；最终皮肤仍由排行榜名次决定。</p><div class="price">统一上榜条件 <b>$300</b></div></div></article></section><div class="guard"><b>模块边界：</b>航迹／行军特效走挖矿排行榜；行军皮肤本体走航海之路$100兑换，两者不混用。</div><div class="foot">内容图来源：X3验收 / 行军特效；活动图来源：用户提供的挖矿小游戏Demo。</div></main></body></html>'''
